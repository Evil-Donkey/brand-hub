                    ...
                    {pricingOptions.map((option, i) => {
                        ...
                        return (        
                            <div className='col-lg-4 mb-5' key={i.toString()}>
                                <div className={`p-4 p-sm-5 px-lg-4 py-lg-5 ${styles.pricingOption} ${textColor == 'dark' ? styles.pricingOptionDark : ''}`} style={{ backgroundColor: backgroundColor, color: textColor == 'dark' ? '#393939' : '#ffffff' }}>
