                ...
                <div className='row justify-content-between align-items-end text-center text-md-start'>
                    ...
                    <div className='col-md-5'>
                        ...
                        <div className={`d-flex flex-column flex-lg-row gap-lg-3 align-items-center ${!content ? 'justify-content-end' : ''}`}>
                            ...
                            {telephone && <a href={`tel:${telephone}`} className="cta__btn cta__btn--transparent mt-3" target="_blank">Call us</a>}
                            {email && <a href={`mailto:${email}`} className="cta__btn cta__btn--transparent mt-3" target="_blank">Email us</a>}
                        </div>
                    </div>
                </div>
            </div>
