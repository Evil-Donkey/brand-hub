...
export async function generateMetadata() {
  try {
    ...
    console.error('Failed to generate metadata for design-subscription-alternative page:', error.message);
    return {
      title: 'Design Subscription Alternative | Brand Hub',
      description: 'Brand Hub Design Subscription Alternative',
    }
  }
}
